        ...
        DCContent expected = DCContent.builder()
                ...
                .replyList(new ArrayList<>(
                                Arrays.asList(
                                        ...
                                        new DCReply("1409577", "모야이", null, "04.09 19:18:44", "그걸 들고 있는 몹과 딸피 몹들이 갇혀있는 처형장 컨셉?", new ArrayList<>(
                                                Arrays.asList(new DCInnerReply("ㅇㅇ", "39.125", "04.09 19:32:45", "이야 이거 좋다 ㅋㅋㅋㅋㅋ"))
                                        )),
                                        new DCReply("1409580", "ㅇㅇ", null, "04.09 19:24:12", "뼉다구 시체타일 늘어놓고 키쿠제단 박기ㅋㅋㅋ", new ArrayList<>()),
